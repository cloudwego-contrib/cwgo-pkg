...
ReadStructBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read struct begin cwerror: ", p), err)
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin cwerror: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' cwerror: ", p, fieldId, fieldIDToName_Request[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d cwerror: ", p, fieldId, fieldTypeId), err)

ReadFieldEndError:
	return thrift.PrependError(fmt.Sprintf("%T read field end cwerror", p), err)
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end cwerror: ", p), err)
}
...
WriteStructBeginError:
	return thrift.PrependError(fmt.Sprintf("%T write struct begin cwerror: ", p), err)
WriteFieldError:
	return thrift.PrependError(fmt.Sprintf("%T write field %d cwerror: ", p, fieldId), err)
WriteFieldStopError:
	return thrift.PrependError(fmt.Sprintf("%T write field stop cwerror: ", p), err)
WriteStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T write struct end cwerror: ", p), err)
}
...
WriteFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T write field 1 begin cwerror: ", p), err)
WriteFieldEndError:
	return thrift.PrependError(fmt.Sprintf("%T write field 1 end cwerror: ", p), err)
}
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin cwerror: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' cwerror: ", p, fieldId, fieldIDToName_Response[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d cwerror: ", p, fieldId, fieldTypeId), err)
...
func (p *helloProcessorEcho) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	if retval, err2 = p.handler.Echo(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal cwerror processing echo: "+err2.Error())
		oprot.WriteMessageBegin("echo", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin cwerror: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' cwerror: ", p, fieldId, fieldIDToName_HelloEchoArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d cwerror: ", p, fieldId, fieldTypeId), err)
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin cwerror: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' cwerror: ", p, fieldId, fieldIDToName_HelloEchoResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d cwerror: ", p, fieldId, fieldTypeId), err)
...
func (p *HelloEchoResult) writeField0(oprot thrift.TProtocol) (err error) {
	...
	return nil
WriteFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T write field 0 begin cwerror: ", p), err)
WriteFieldEndError:
	return thrift.PrependError(fmt.Sprintf("%T write field 0 end cwerror: ", p), err)
}
