// Code generated by thriftgo (0.0.25). DO NOT EDIT.
...
ReadStructBeginError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_read struct begin error: ", p), err)
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_read field %d '%s' error: ", p, fieldId, fieldIDToName_Request[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)

ReadFieldEndError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_read field end error", p), err)
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_read struct end error: ", p), err)
}
...
WriteStructBeginError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_write struct begin error: ", p), err)
WriteFieldError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_write field %d error: ", p, fieldId), err)
WriteFieldStopError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_write field stop error: ", p), err)
WriteStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_write struct end error: ", p), err)
}
...
WriteFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_write field 1 begin error: ", p), err)
WriteFieldEndError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_write field 1 end error: ", p), err)
}
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_read field %d '%s' error: ", p, fieldId, fieldIDToName_Response[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_read field %d '%s' error: ", p, fieldId, fieldIDToName_EchoEchoArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_read field %d '%s' error: ", p, fieldId, fieldIDToName_EchoEchoResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *EchoEchoResult) writeField0(oprot thrift.TProtocol) (err error) {
	...
	return nil
WriteFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_write field 0 begin error: ", p), err)
WriteFieldEndError:
	return thrift.PrependError(fmt.Sprintf("%T streaming_write field 0 end error: ", p), err)
}
